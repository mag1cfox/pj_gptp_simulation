...
class Network:
    ...
    def plot_results(self, hop):
        ...
        save_tuple_to_csv(errors_new, filename=r'D:\06_engineering\03_analysis\pj_gptp_simulation\old_version\main_test5\output_data/data20250413v1.csv')
...
def save_tuple_to_csv(tuple_data, filename=r'D:\06_engineering\03_analysis\pj_gptp_simulation\old_version\main_test5\output_data/data20250413v1.csv'):
    # 检查文件是否存在
